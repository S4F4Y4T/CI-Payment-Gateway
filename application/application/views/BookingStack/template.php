...
<!--begin::Head-->
<?php $this->load->view($theme . '/templates/head', $head_data); ?>
<!--end::Head-->
...
<!--begin::Header Mobile-->
<?php $this->load->view($theme . '/templates/mobile_header'); ?>
<!--end::Header Mobile-->
...
<div class="d-flex flex-column flex-root">
    ...
    <div class="d-flex flex-row flex-column-fluid page">
        ...
        <!--begin::Aside-->
        <?php $this->load->view($theme . '/templates/aside', $aside_data); ?>
        <!--end::Aside-->
        ...
        <div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
            ...
            <!--begin::Header-->
            <?php $this->load->view($theme . '/templates/header'); ?>
            <!--end::Header-->
            ...
            <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                ...
                <?php $this->load->view($theme . '/' . $view, $view_data); ?>
            </div>
            <!--end::Content-->

            <!--begin::Footer-->
            <?php $this->load->view($theme . '/templates/footer'); ?>
            <!--end::Footer-->
...
<div id="kt_scrolltop" class="scrolltop">
		<span class="svg-icon">
			<!--begin::Svg Icon | path:<?php echo site_url(); ?>assets/<?php echo $theme; ?>/dist/assets/media/svg/icons/Navigation/Up-2.svg-->
