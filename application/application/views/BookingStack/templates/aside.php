<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
    ...
    <div class="brand flex-column-auto" id="kt_brand">
        ...
        <a href="index.html" class="brand-logo">
            <img alt="Logo"
                 src="<?php echo site_url(); ?>assets/<?php echo $theme; ?>/dist/assets/media/logos/<?php echo $brand_logo; ?>"
    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
        ...
        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
            ...
            <!--begin::Menu Nav-->
            <ul class="menu-nav">
                <li class="menu-item <?php if ($parent_page == "Dashboard") {
                    ...
                    <div class="menu-submenu">
                        ...
                        <ul class="menu-subnav">
                            ...
                            <li class="menu-item" aria-haspopup="true">
                                <a href="<?= base_url(); ?>services/add_service" class="menu-link">
                            ...
                            <li class="menu-item" aria-haspopup="true">
                                <a href="<?= base_url(); ?>services/service_addons" class="menu-link">
                                    <i class="menu-bullet menu-bullet-line">
                                        <span></span>
                                    </i>
                            ...
                            <li class="menu-item" aria-haspopup="true">
                                <a href="<?= base_url(); ?>services/pricing_methods" class="menu-link">
                                    <i class="menu-bullet menu-bullet-line">
                                        <span></span>
                                    </i>
                                    <span class="menu-text">Pricing Methods</span>
                                    <span class="menu-label">
														<span class="label label-danger label-inline">new</span>
													</span>
                                </a>
                            ...
                            <li class="menu-item" aria-haspopup="true">
                                <a href="<?= base_url(); ?>services/pricing_method_units" class="menu-link">
                                    <i class="menu-bullet menu-bullet-line">
                                        <span></span>
                                    </i>
                                    <span class="menu-text">Pricing Method Units</span>
                                    <span class="menu-label">
														<span class="label label-danger label-inline">new</span>
													</span>
                                </a>
